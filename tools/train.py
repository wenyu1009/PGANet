...
def train(cfg):
    ...
    if cfg.MODEL.IF_WITH_CENTER == 'no':
        ...
        arguments = {}
        print("train图片大小:", cfg.INPUT.SIZE_TRAIN)
        print("test图片大小:", cfg.INPUT.SIZE_TEST)
        do_train(
            cfg,
            model,
            train_loader,
...
def main():
    ...
    parser.add_argument(
        "--config_file", default="/home/zwy/dl-reid/configs/softmax_triplet_with_center.yml", help="path to config file", type=str
    )
    ...
    logger.info("Using {} GPUS".format(num_gpus)) #开始记录日志信息
    logger.info(args)
